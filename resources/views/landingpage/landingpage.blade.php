            ...
            <div class="navbar-header">
                ...
                <div class="d-flex">
                    ...
                    <div class="dropdown d-inline-block language-switch">
                        <button type="button" class="btn header-item" data-bs-toggle="dropdown" aria-haspopup="true"
                            aria-expanded="false">
                            <img class="header-lang-img" src="{{ asset('assets/images/flags/us.jpg') }}"
                                            ...
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu" aria-labelledby="topnav-contact">
                                                    ...
                                                    <a href="contacts-profile.html" class="dropdown-item"
                                                        data-key="t-user-profile">User Profile</a>
                                                </div>
                                            </div>
                                        </div>
                                    </li>
                                ...
                                <div class="card-body">
                                    <div class="text-center py-3">
                                        ...
                                        <div class="main-wid position-relative">
                                            ...
                                            <p class="text-white-50 px-4 mt-4">Maecenas nec odio et ante tincidunt
                                                tempus. Donec vitae sapien libero tincidunt.</p>
                                ...
                                <div class="col-lg-3 col-md-6">
                                    <div class="card">
                                        <div class="card-body">
                                            ...
                                            <h4 class="mt-1 mb-0">3,89,658 <sup
                                                    class="text-success fw-medium font-size-14"><i
                                            ...
                                            <div>
                                                ...
                                                <ul
                                                    ...
                                                    <li class="list-inline-item"><a href=""
                                                            class="text-muted">Day</a></li>
                                                    <li class="list-inline-item"><a href=""
                                                            class="text-muted">Week</a></li>
                                                    <li class="list-inline-item"><a href=""
                                                            class="text-muted">Month</a></li>
                                                    <li class="list-inline-item"><a href=""
                                                            class="text-muted">Year</a></li>
                                                </ul>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="col-lg-3 col-md-6">
                                    <div class="card">
                                        <div class="card-body">
                                            ...
                                            <h4 class="mt-1 mb-0">1,648,29 <sup
                                                    class="text-danger fw-medium font-size-14"><i
                                ...
                                <div class="col-lg-3 col-md-6">
                                    <div class="card">
                                        <div class="card-body">
                                            ...
                                            <h4 class="mt-1 mb-0">6,48,249 <sup
                                                    class="text-success fw-medium font-size-14"><i
                                    ...
                                    <div class="card">
                                        <div class="card-body">
                                            <div class="avatar">
                                                <span class="avatar-title bg-success-subtle rounded">
                                                    <i
                                                        class="mdi mdi-account-multiple-outline text-success font-size-24"></i>
                                                </span>
                                            </div>
                                            <p class="text-muted mt-4 mb-0">New Users</p>
                                            <h4 class="mt-1 mb-0">$5,265,3 <sup
                                                    class="text-danger fw-medium font-size-14"><i
                                            ...
                                            <div class="">
                                                <div>
                                                    <div class="d-flex justify-content-between align-items-center">
                                                        <div class="d-flex">
                                                            <i
                                                                class="mdi mdi-circle font-size-10 mt-1 text-primary"></i>
                                                ...
                                                <div class="mt-3 border-top pt-3">
                                                    <div class="d-flex justify-content-between align-items-center">
                                                        <div class="d-flex">
                                                            <i
                                                                class="mdi mdi-circle font-size-10 mt-1 text-success"></i>
                                                            <div class="flex-1 ms-2">
                                                        ...
                                                        <div>
                                                            <span
                                                                class="badge text-success  bg-success-subtle">16.3%<i
                                ...
                                <div class="col-lg-5">
                                    <div class="card">
                                        ...
                                        <div class="card-body px-0">
                                            <ol class="activity-feed mb-0 px-4" data-simplebar
                                                ...
                                                <li class="feed-item">
                                                    <div class="d-flex justify-content-between feed-item-list">
                                                        <div>
                                                            <h5 class="font-size-15 mb-1">You have 5 pending order.
                                                            </h5>
                                                ...
                                                <li class="feed-item">
                                                    <div class="d-flex justify-content-between feed-item-list">
                                                        <div>
                                                            <h5 class="font-size-15 mb-1">You have 1 pending order.
                                                            </h5>
                                                ...
                                                <table
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td><span
                                                                    class="badge text-info bg-info-subtle font-size-12">Active</span>
                                                            </td>
                                                            <td>
                                                                <div class="dropdown">
                                                                    <a class="text-muted dropdown-toggle font-size-20"
                                ...
                                <div class="card-body pt-1">
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-centered align-middle table-nowrap mb-0">
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td><img src="{{ asset('assets/images/flags/us.jpg') }}"
                                                            alt="user-image" class="me-3" height="18">US</td>
                                                    <td>
                                                        26,568.84
                                                    </td>
                                                    <td>
                                                ...
                                                <tr>
                                                    <td><img src="{{ asset('assets/images/flags/germany.jpg') }}"
                                                            alt="user-image" class="me-3" height="18">German
                                                    </td>
                                                    <td>
                                                        36,485.52
                                                    </td>
                                                ...
                                                <tr>
                                                    <td><img src="{{ asset('assets/images/flags/italy.jpg') }}"
                                                            alt="user-image" class="me-3" height="18">Italy
                                                    </td>
                                                    <td>
                                                        17,568.84
                                                    </td>
                                                ...
                                                <tr>
                                                    <td><img src="{{ asset('assets/images/flags/spain.jpg') }}"
                                                            alt="user-image" class="me-3" height="18">Spain
                                                    </td>
                                                    <td>
                                                        75,521.28
                                                    </td>
                        ...
                        <div class="col-xl-4">
                            ...
                            <div class="card">
                                ...
                                <div class="card-body py-xl-0">
                                    <div id="earning-item" data-colors='["#33a186","#3980c0"]' class="apex-charts"
                                        dir="ltr"></div>
                                </div>
                            </div>
